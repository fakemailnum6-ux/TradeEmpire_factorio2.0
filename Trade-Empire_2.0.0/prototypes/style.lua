...
local default_gui_style = data.raw["gui-style"].default

default_gui_style["teshop_button_style"] =
  {
    type = "button_style",
    parent = "button",
    top_padding = 1,
...
default_gui_style["teshop_sprite_button"] =
  {
    type = "button_style",
...
default_gui_style["teshop_main_button"] =
  {
    type = "button_style",
